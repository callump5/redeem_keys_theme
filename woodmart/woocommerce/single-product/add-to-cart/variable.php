...
if($rks_affiliate){ 
    ...
    echo "<h2 style='margin-bottom: 0px'>Online Key Price Comparison</h2>";
    echo "<p>Below is a table of prices for {$product->get_title()} Key from trusted sellers. We are currently working on automating fetching prices from a number of online key sellers, all with a goal of bringing you the best price possible.</p>";
    echo "<table class='rks-affiliates'>";
        ...
        foreach ( $available_variations as $variation) {
            ...
            echo "<tr class='rks-affiliates--item'>";
                ...
                echo "<td><a style='color:black !important' target='_blank' href='{$variation_link}'>View Key</a></td>";
            echo "</tr>";
